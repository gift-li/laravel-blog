...
class CreatePostTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('posts', function (Blueprint $table) {
            ...
            $table->foreign('author_id')->references('id')->on('users')->onDelete('cascade'); // Due to declaring cascade on foreign key, the operation on deleting users should be much more careful
            $table->string('title');
