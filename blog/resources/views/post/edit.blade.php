...
<form class="row justify-content-center mx-auto" action="{{ route('post.update', $post->id)}}" method="post">
    ...
    <div class="col text-center">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea name="content" id="content" rows="10" class="form-control border border-grey" placeholder="content">{{ $post->content }}</textarea>
            </div>
        </div>
        <button class="btn btn-primary" type="submit">更新貼文</button>
    </div>
</form>
@endsection